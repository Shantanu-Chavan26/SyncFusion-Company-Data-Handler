...
const Navbar = () => {
  ...
  //   // Add logic to handle clicks for different components like 'cart', 'chat', etc.
      ...
      <div className='flex'>
        ...
        />
          ...
          <TooltipComponent content="profile" position="BottomCenter">
            ...
            <div className='flex items-center gap-2 cursor-pointer  p-1 hover:bg-light-gray rounded-r-lg' onClick={()=>('userProfile')}>
